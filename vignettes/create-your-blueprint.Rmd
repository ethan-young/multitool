...
There are two steps in finalizing your bluerprint. The first is to visualize your pipeline with a graph. This is optional, but I think it is helpful. 
...
create_blueprint_graph(full_pipeline, width = 450, height = 500)
```
