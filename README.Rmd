...
2. **specification blueprint:** (also termed specification grid) a blueprint/map/recipe or whatever you want to call it. These are the instructions for what to do.
