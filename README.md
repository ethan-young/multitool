...
#> ■■■■■■■■■■■■■ 40% | ETA: 3s■■■■■■■■■■■■■■■ 48% | ETA: 3s■■■■■■■■■■■■■■■■ 50% |
#> ETA: 3s■■■■■■■■■■■■■■■■■ 54% | ETA: 3s■■■■■■■■■■■■■■■■■■■ 58% | ETA:
#> 2s■■■■■■■■■■■■■■■■■■■ 60% | ETA: 2s■■■■■■■■■■■■■■■■■■■■ 65% | ETA:
#> 2s■■■■■■■■■■■■■■■■■■■■■ 67% | ETA: 2s■■■■■■■■■■■■■■■■■■■■■■ 71% | ETA:
#> 2s■■■■■■■■■■■■■■■■■■■■■■■ 75% | ETA: 1s■■■■■■■■■■■■■■■■■■■■■■■■ 77% | ETA:
#> 1s■■■■■■■■■■■■■■■■■■■■■■■■■ 81% | ETA: 1s■■■■■■■■■■■■■■■■■■■■■■■■■■ 83% | ETA:
...
#>  1 1        <tibble>     the_da… (Int…  0.0911   0.0573   1.59  0.113   <tibble>
#>  2 1        <tibble>     the_da… iv1    0.108    0.0644   1.68  0.0942  <tibble>
#>  3 1        <tibble>     the_da… mod   -0.161    0.0612  -2.63  0.00889 <tibble>
#>  4 1        <tibble>     the_da… iv1:…  0.0121   0.0725   0.167 0.868   <tibble>
#>  5 2        <tibble>     the_da… (Int… -0.0424   0.0624  -0.679 0.498   <tibble>
#>  6 2        <tibble>     the_da… iv1    0.0502   0.0702   0.715 0.475   <tibble>
#>  7 2        <tibble>     the_da… mod    0.00791  0.0667   0.118 0.906   <tibble>
#>  8 2        <tibble>     the_da… iv1:…  0.0166   0.0789   0.211 0.833   <tibble>
#>  9 3        <tibble>     the_da… (Int…  0.0970   0.0574   1.69  0.0919  <tibble>
#> 10 3        <tibble>     the_da… iv2    0.0732   0.0540   1.36  0.176   <tibble>
...
#>  1 1        <tibble>     the_da… <tibble> 3.17e-2  2.20e-2 0.993  3.25    0.0221
#>  2 2        <tibble>     the_da… <tibble> 1.79e-3 -8.26e-3 1.08   0.178   0.911 
#>  3 3        <tibble>     the_da… <tibble> 2.86e-2  1.88e-2 0.994  2.93    0.0341
#>  4 4        <tibble>     the_da… <tibble> 9.10e-3 -8.79e-4 1.08   0.912   0.436 
#>  5 5        <tibble>     the_da… <tibble> 2.35e-2  1.37e-2 0.997  2.39    0.0690
#>  6 6        <tibble>     the_da… <tibble> 3.49e-4 -9.71e-3 1.08   0.0346  0.991 
#>  7 7        <tibble>     the_da… <tibble> 3.07e-2  2.10e-2 0.990  3.16    0.0249
#>  8 8        <tibble>     the_da… <tibble> 2.05e-3 -7.93e-3 1.08   0.205   0.893 
#>  9 9        <tibble>     the_da… <tibble> 2.74e-2  1.77e-2 0.992  2.82    0.0391
#> 10 10       <tibble>     the_da… <tibble> 9.03e-3 -8.81e-4 1.07   0.911   0.436 
...
#>  1 1        <tibble [1 × 3]> (Intercept)  0.0911     0.0573     1.59  0.113  
#>  2 1        <tibble [1 × 3]> iv1          0.108      0.0644     1.68  0.0942 
#>  3 1        <tibble [1 × 3]> mod         -0.161      0.0612    -2.63  0.00889
#>  4 1        <tibble [1 × 3]> iv1:mod      0.0121     0.0725     0.167 0.868  
#>  5 2        <tibble [1 × 3]> (Intercept) -0.0424     0.0624    -0.679 0.498  
#>  6 2        <tibble [1 × 3]> iv1          0.0502     0.0702     0.715 0.475  
#>  7 2        <tibble [1 × 3]> mod          0.00791    0.0667     0.118 0.906  
#>  8 2        <tibble [1 × 3]> iv1:mod      0.0166     0.0789     0.211 0.833  
#>  9 3        <tibble [1 × 3]> (Intercept)  0.0970     0.0574     1.69  0.0919 
#> 10 3        <tibble [1 × 3]> iv2          0.0732     0.0540     1.36  0.176  
#> # … with 182 more rows
```
...
#>  1 1        iv1   dv1   include1 =… includ… scale(… lm(d… linear… (Int…  0.0911 
#>  2 1        iv1   dv1   include1 =… includ… scale(… lm(d… linear… iv1    0.108  
#>  3 1        iv1   dv1   include1 =… includ… scale(… lm(d… linear… mod   -0.161  
#>  4 1        iv1   dv1   include1 =… includ… scale(… lm(d… linear… iv1:…  0.0121 
#>  5 2        iv1   dv2   include1 =… includ… scale(… lm(d… linear… (Int… -0.0424 
#>  6 2        iv1   dv2   include1 =… includ… scale(… lm(d… linear… iv1    0.0502 
#>  7 2        iv1   dv2   include1 =… includ… scale(… lm(d… linear… mod    0.00791
#>  8 2        iv1   dv2   include1 =… includ… scale(… lm(d… linear… iv1:…  0.0166 
#>  9 3        iv2   dv1   include1 =… includ… scale(… lm(d… linear… (Int…  0.0970 
#> 10 3        iv2   dv1   include1 =… includ… scale(… lm(d… linear… iv2    0.0732 
...
#>   <chr> <chr>         <dbl>           <dbl>
#> 1 iv1   dv1         0.0487          0.0446 
#> 2 iv1   dv2         0.0125          0.00649
#> 3 iv2   dv1         0.0290          0.0279 
#> 4 iv2   dv2        -0.0270         -0.0198 
#> 5 iv3   dv1        -0.00672        -0.00291
#> 6 iv3   dv2         0.00810         0.00446
```
...
#>    <chr>       <chr> <chr>         <dbl>           <dbl>
#>  1 (Intercept) iv1   dv1         0.0631          0.0595 
#>  2 (Intercept) iv1   dv2        -0.0243         -0.0267 
#>  3 (Intercept) iv2   dv1         0.0673          0.0638 
#>  4 (Intercept) iv2   dv2        -0.0265         -0.0284 
#>  5 (Intercept) iv3   dv1         0.0671          0.0641 
#>  6 (Intercept) iv3   dv2        -0.0234         -0.0252 
#>  7 iv1         iv1   dv1         0.0657          0.0664 
#>  8 iv1         iv1   dv2         0.0198          0.0216 
#>  9 iv1:mod     iv1   dv1         0.0317          0.0330 
#> 10 iv1:mod     iv1   dv2         0.00518         0.00649
#> # … with 14 more rows
```
